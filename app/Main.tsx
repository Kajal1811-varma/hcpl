...
export default function Home() {
  ...
  return (
    <>
      <div className="h-130 relative overflow-hidden"  data-aos="fade-up">
        {images.map((image, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 text-center" >
              <h2 className="text-md mb-2 uppercase text-white"  data-aos="fade-up">{image.subtitle}</h2>
              <h1 className="mx-4 mb-4 text-3xl font-bold text-white md:text-6xl "  data-aos="fade-up">
                {image.title}
              </h1>
